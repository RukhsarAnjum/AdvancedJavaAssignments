...
import main.java.jpatraining.onetomany.Employees;
...
public class OneToMany {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Employees employee1= new Employees(1001,"Smith",new Date());
            Employees employee2= new Employees(1002,"Jones",new Date());
